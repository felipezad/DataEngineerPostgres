...
time_table_create = ("""
CREATE TABLE IF NOT EXISTS time(start_time varchar , hour varchar, day varchar, week varchar, month varchar, year varchar, weekday varchar)
""")

songplay_table_create =  ("""
CREATE TABLE IF NOT EXISTS songplays(start_time varchar , user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar);
""")
